                ...
                <form class="mx-1 mx-md-4 mt-4" action="<?php echo base_url('login'); ?>" method="post">
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      ...
                      <input type="email" id="form3Example3c" class="form-control" placeholder="Example@gmail.com" />
                    </div>
                  </div>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      ...
                      <input type="password" class="form-control is-invalid" id="form3Example4c" class="form-control" placeholder="Your password" />
                    </div>
                  </div>
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button type="button" class="btn btn-primary btn-lg mt-2">Đăng nhập</button>
                  </div>
